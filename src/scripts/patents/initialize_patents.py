...
def main(bootstrap: bool = False):
    ...
    # update annotations set instance_rollup=term where domain not in ('attributes', 'assignees') and lower(instance_rollup) in ('salts', 'bacteria', 'peptides', 'inhibitor',  'modulator', 'disease','antagonist', 'agonist', 'syndrome', 'abnormality of digestive system morphology', 'proteins', 'antibodies', 'catalyst', 'agent', 'promoters', 'enhancer of transcription', 'laboratory chemicals', 'monomers', 'syndrome', 'disease', 'cells', 'chemical group', 'copolymer', 'polymers', 'plant-based natural product', 'degrader');
    # delete from annotations where lower(term) in ('inhibitor', 'peptides','composition', 'effect', 'disease', 'base sequence','salts', 'bacteria', 'alleles', 'modulator', 'syndrome', 'antibodies', 'abnormality of digestive system morphology', 'antagonist', 'agonist', 'proteins', 'catalyst', 'agent', 'promoters', 'enhancer of transcription', 'laboratory chemicals', 'monomers', 'syndrome', 'disease', 'cells', 'chemical group', 'copolymer', 'polymers', 'plant-based natural product', 'degrader');
