NER_TYPES = sorted(
    [
        ...
        },
        {
            "dataset": "BIOSYM",
            "name": "procedures",
            "description": "A medical procedure is a course of action intended to achieve a result in the delivery of healthcare.",
            "description_source": "https://en.wikipedia.org/wiki/Medical_procedure",
        },
        {
            "dataset": "BIOSYM",
            "name": "diseases",
    ...
    # order determines the type id, so always keep this in sync with binder
    key=lambda x: x["name"],
    # reverse=True,
)
