...
MANUAL_INDICES = [
    """
    CREATE INDEX IF NOT EXISTS patent_vector ON patent USING hnsw (vector vector_l2_ops);
    """,
    """
    CREATE INDEX IF NOT EXISTS trial_vector ON trial USING hnsw (vector vector_l2_ops);
    """,
    """
